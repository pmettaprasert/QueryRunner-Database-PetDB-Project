...
public class QueryJDBC {
    ...
    //Added an attribute to the class to return the error messages
    String justTheError = "";
    ...
    //Added a public method to retrieve the error message only and not the state
    //and error code as well.
    ...
    public boolean ExecuteQuery(String szQuery, String [] parms, boolean [] likeparms)
    {
        ...
        catch (SQLException ex) 
        {
            ...
            //justTheError retrieves only the SQL exception messages
            justTheError = ex.getMessage();
    ...
    /** Returns a boolean where if you close the database correctly and sever
     * the connection between this program and the database then return true.
     * Otherwise return false. This will be called in the QueryRunner method
     * called disconnect.
     * @return Boolean where it is true if you disconnect from the SQL Server
     * correctly and false if it is not.
    */
